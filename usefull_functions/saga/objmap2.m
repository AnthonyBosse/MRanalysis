function [xi,yi,zi,em] = objmap2(xb,yb,zb,xi,yi,fun,p,err,n)
...
% xb=MX;yb=MY';xi=X';yi=Y;zb=MMU;p=[lx ly];err=0.05
%
...
if is_err, em = zeros(length(xi),length(yi));
%if is_err, em = zeros(size(xi));
end
