...
PATHNAME='/home/abosse/Bureau/Nextcloud_Pytheas/glider_analysis/glider_obs/TOPO/ETOPO2/';   % Be sure to end the path with a "/" or
...
resolution=2;  % 2 = 2 minute (etopo2), 1 = 1 minute (etopo1)
